      ...
      <div className='grid grid-cols-1'>
        ...
        <div className='max-mdx:mx-auto max-mdx:w-full max-xl:max-w-(--breakpoint-mdx)'>
          ...
          <GridContainer className='mdx:mb-32 px-12'>
            <h1 className='mdx:text-4xl flex min-h-80 max-w-(--breakpoint-md) items-center py-8 font-mono text-2xl font-bold tracking-tight text-pretty text-gray-950 [view-transition-name:blog-page] dark:text-gray-200'>
              {post.metadata.title}
            </h1>
          </GridContainer>
        </div>
